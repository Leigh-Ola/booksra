...
const getAppConfig = () => {
    ...
    return {
        ...
        EMAIL_MIN_INTERVAL: parseInt(String(processEnvObj.EMAIL_MIN_INTERVAL), 5) || 5,
        ...
        SELF_PAYMENT_PERCENTAGE: parseInt(processEnvObj.SELF_PAYMENT_PERCENTAGE, 10) || 10,
        SELF_PAYMENT_MONTHLY_MAX_AMOUNT: parseInt(processEnvObj.SELF_PAYMENT_MONTHLY_MAX_AMOUNT, 10) || 400000,
        ...
        DB: {
            ...
            maxPoolConnCount: parseInt(String(processEnvObj.DB_CONN_POOL_COUNT), 10) || 10,
        },
    };
};
