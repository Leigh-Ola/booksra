...
exports.IsUser = IsUser = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [jwt_1.JwtService])
], IsUser);
let IsAdminUser = class IsAdminUser {
    constructor(jwtService) {
        this.jwtService = jwtService;
    }
    async canActivate(context) {
        ...
        try {
            ...
            if (payload.role !== types_1.AppAccessLevelsEnum.ADMIN &&
                payload.role !== types_1.AppAccessLevelsEnum.SUPERADMIN) {
...
exports.IsAdminUser = IsAdminUser = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [jwt_1.JwtService])
], IsAdminUser);
let IsSuperAdminUser = class IsSuperAdminUser {
    constructor(jwtService) {
        this.jwtService = jwtService;
    }
    async canActivate(context) {
...
exports.IsSuperAdminUser = IsSuperAdminUser = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [jwt_1.JwtService])
], IsSuperAdminUser);
