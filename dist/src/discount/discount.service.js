...
let DiscountService = class DiscountService {
    ...
    async create(discountDto) {
        ...
        else if (discountDto.category === types_1.DiscountCategoryEnum.GLOBAL) {
            if (discountDto.couponType) {
                return (0, helpers_1.throwBadRequest)('Coupon type should be null for global discounts');
            }
            discount.couponType = types_1.CouponTypeEnum.MINIMUM_PRICE;
        }
    ...
    async update(id, discountDto) {
        ...
        else if (discountExists.category === types_1.DiscountCategoryEnum.GLOBAL) {
            if (discountDto.couponType) {
                return (0, helpers_1.throwBadRequest)('You cannot change the coupon type for global discounts');
            }
        }
